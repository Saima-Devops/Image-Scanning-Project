...
2. integrate the scanner into popular CI/CD pipelines (e.g., Jenkins or GitHub Actions) to ensure continuous security checks.
...
Done by Junior DevOps Team (Fancy Kejriwal, Saima Usman & Rahul Kumar) \
